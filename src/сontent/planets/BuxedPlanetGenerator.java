...
public class BuxedPlanetGenerator extends PlanetGenerator{
    ...
    Block[][] arr = {
            {Blocks.basalt, Blocks.sand, Blocks.dacite, Blocks.stone, Blocks.craters},
            {Blocks.basalt, Blocks.sand, Blocks.dacite, Blocks.stone, Blocks.craters},
            {Blocks.basalt, Blocks.sand, Blocks.dacite, Blocks.stone, Blocks.craters},
            {Blocks.basalt, Blocks.sand, Blocks.dacite, Blocks.stone, Blocks.craters},
    };
    ...
    ObjectMap<Block, Block> dec = ObjectMap.of(
            Blocks.basalt, Blocks.dacite, Blocks.craters
    );

    ObjectMap<Block, Block> tars = ObjectMap.of(
            Blocks.darksand, Blocks.darkMetal
    );
    ...
    protected void generate(){
        ...
        for(int i = 0; i < rooms; i++){
            ...
            float rrad = Math.min(rand.random(15f, maxrad / 2f), 30f);
        ...
        int ruinCount = rand.random(0, 20);
        if(ruinCount > 0){
            int padding = 25;
